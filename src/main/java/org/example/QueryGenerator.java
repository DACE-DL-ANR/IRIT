...
public class QueryGenerator {
    ...
    public void qGenerator() {
      //  we are iterating over the set of constructs, a construct contains a set of sparql queries
        File folder = new File("alignments/construct");
        File[] listOfFiles = folder.listFiles();
        HashMap<String, HashMap<String, Query>> queriesPerOnto = new HashMap<>();
        ...
        for (int i = 0; i < listOfFiles.length; i++) {
            ...
            if (!queriesPerOnto.containsKey(o1)) {
                queriesPerOnto.put(o1, new HashMap<>());
            }
            if (!queriesPerOnto.containsKey(o2)) {
                queriesPerOnto.put(o2, new HashMap<>());
            }
            String content = "";
            try {
